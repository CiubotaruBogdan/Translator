...
**Aplicarea propunerilor**: fiecare propunere poate fi bifată („Aplică această propunere"), iar butonul **„Generează document revizuit"** reconstruiește documentul înlocuind segmentele acceptate cu traducerile îmbunătățite. Pentru fișierele **DOCX** revizuirea se aplică peste originalul, păstrând formatarea; pentru TXT/PDF se generează un document cu textul corectat. Documentul revizuit se descarcă separat, fără a suprascrie traducerea inițială.
